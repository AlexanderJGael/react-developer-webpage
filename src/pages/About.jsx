            ...
            <div className="container my-5">
                <div id="about-card" className="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 shadow-lg">
                    <div className="col-lg-7 p-3 p-lg-5 pt-lg-3">
                        ...
                        <p className="lead text-start">They are passionate about what they do. Whether it is building a new web application, or improving an existing one, Ally will get the job done. <br />Browse around the site and use the 'Contact Me' page to get in touch!</p>
                    </div>
